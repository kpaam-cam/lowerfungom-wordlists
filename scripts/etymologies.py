...
wl = Wordlist('../analyses/AllAvailable-33coverage.tsv-cognates-0.45_0.55thresholds.tsv')
...
varietyStabilities_df.to_csv("../analyses/ConceptStabilityByVariety.tsv", sep="\t", index=False,)		
...
conceptStabilities_df.to_csv("../analyses/ConceptStabilityByConcept.tsv", sep="\t", index=False,)		
