...
# the ordering.
# Run from this directory with: Rscript annotated_heatmap_two_scale_bridge_seriation.R

input <- "../Good-WestermannPaperSupplementalMaterials/analyses/kplfSubset-SCA-0.45_threshold-heatmap.matrix.dst"
png_out <- "annotated_subunit_heatmap_two_scale_bridge_seriation.png"
pdf_out <- "annotated_subunit_heatmap_two_scale_bridge_seriation.pdf"
heatmap_only_png <- "heatmap_only_two_scale_bridge_seriation.png"
heatmap_only_pdf <- "heatmap_only_two_scale_bridge_seriation.pdf"
...
crop_heatmap_only <- function() {
  ...
  if (nzchar(magick)) {
    trimmed_png <- file.path(tempdir(), "heatmap_only_two_scale_bridge_seriation_trimmed.png")
  ...
  if (nzchar(pdfcrop)) {
    cropped_pdf <- file.path(tempdir(), "heatmap_only_two_scale_bridge_seriation_cropped.pdf")
