# Alternate version of annotated_heatmap.R: all manual, hand-fixed reordering
# of the dark-blue subunit runs (Missong/Abar/Ngun/Biya/Munken) is disabled.
# Only the raw hclust order and the automatic block-order optimizer act on
# the data, so this shows what "free" seriation produces without anyone
# manually fixing which blue-colored runs sit next to each other.
# Run from this directory with: Rscript annotated_heatmap_free_seriation.R

input <- "../Good-WestermannPaperSupplementalMaterials/analyses/kplfSubset-SCA-0.45_threshold-heatmap.matrix.dst"
png_out <- "annotated_subunit_heatmap_free_seriation.png"
pdf_out <- "annotated_subunit_heatmap_free_seriation.pdf"
heatmap_only_png <- "heatmap_only_free_seriation.png"
heatmap_only_pdf <- "heatmap_only_free_seriation.pdf"
